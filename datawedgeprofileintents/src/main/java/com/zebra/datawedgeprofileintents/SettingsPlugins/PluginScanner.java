...
public class PluginScanner
{
    ...
    */
    ...
    {
        if(mConfigToBeCompared == null || scanner_input_enabled != mConfigToBeCompared.scanner_input_enabled)
            barcodeProps.putString("scanner_input_enabled", scanner_input_enabled ? "true" : "false");

        // Use this for Datawedge < 6.7
        if(mConfigToBeCompared == null || scanner_selection != mConfigToBeCompared.scanner_selection)
           barcodeProps.putString("scanner_selection", scanner_selection);

        // Use this for Datawedge < 6.7
        //barcodeProps.putString("scanner_selection", "AUTO");
        // Use this for Datawedge >= 6.7
        if(mConfigToBeCompared == null || scanner_selection_by_identifier != mConfigToBeCompared.scanner_selection_by_identifier)
    ...
    private  void setupDecoders(Bundle barcodeProps) {
        if(mConfigToBeCompared == null || Decoders.decoder_australian_postal                       != mConfigToBeCompared.Decoders.decoder_australian_postal                 ) barcodeProps.putBoolean(   "decoder_australian_postal"                , Decoders.decoder_australian_postal                );
        if(mConfigToBeCompared == null || Decoders.decoder_aztec                                   != mConfigToBeCompared.Decoders.decoder_aztec                             ) barcodeProps.putBoolean(   "decoder_aztec"                            , Decoders.decoder_aztec                            );
        if(mConfigToBeCompared == null || Decoders.decoder_canadian_postal                         != mConfigToBeCompared.Decoders.decoder_canadian_postal                   ) barcodeProps.putBoolean(   "decoder_canadian_postal"                  , Decoders.decoder_canadian_postal                  );
        if(mConfigToBeCompared == null || Decoders.decoder_chinese_2of5                            != mConfigToBeCompared.Decoders.decoder_chinese_2of5                      ) barcodeProps.putBoolean(   "decoder_chinese_2of5"                     , Decoders.decoder_chinese_2of5                     );
        if(mConfigToBeCompared == null || Decoders.decoder_codabar                                 != mConfigToBeCompared.Decoders.decoder_codabar                           ) barcodeProps.putBoolean(   "decoder_codabar"                          , Decoders.decoder_codabar                          );
        if(mConfigToBeCompared == null || Decoders.decoder_code11                                  != mConfigToBeCompared.Decoders.decoder_code11                            ) barcodeProps.putBoolean(   "decoder_code11"                           , Decoders.decoder_code11                           );
        if(mConfigToBeCompared == null || Decoders.decoder_code128                                 != mConfigToBeCompared.Decoders.decoder_code128                           ) barcodeProps.putBoolean(   "decoder_code128"                          , Decoders.decoder_code128                          );
        if(mConfigToBeCompared == null || Decoders.decoder_code39                                  != mConfigToBeCompared.Decoders.decoder_code39                            ) barcodeProps.putBoolean(   "decoder_code39"                           , Decoders.decoder_code39                           );
        if(mConfigToBeCompared == null || Decoders.decoder_code93                                  != mConfigToBeCompared.Decoders.decoder_code93                            ) barcodeProps.putBoolean(   "decoder_code93"                           , Decoders.decoder_code93                           );
        if(mConfigToBeCompared == null || Decoders.decoder_composite_ab                            != mConfigToBeCompared.Decoders.decoder_composite_ab                      ) barcodeProps.putBoolean(   "decoder_composite_ab"                     , Decoders.decoder_composite_ab                     );
        if(mConfigToBeCompared == null || Decoders.decoder_composite_c                             != mConfigToBeCompared.Decoders.decoder_composite_c                       ) barcodeProps.putBoolean(   "decoder_composite_c"                      , Decoders.decoder_composite_c                      );
        if(mConfigToBeCompared == null || Decoders.decoder_d2of5                                   != mConfigToBeCompared.Decoders.decoder_d2of5                             ) barcodeProps.putBoolean(   "decoder_d2of5"                            , Decoders.decoder_d2of5                            );
        if(mConfigToBeCompared == null || Decoders.decoder_datamatrix                              != mConfigToBeCompared.Decoders.decoder_datamatrix                        ) barcodeProps.putBoolean(   "decoder_datamatrix"                       , Decoders.decoder_datamatrix                       );
        if(mConfigToBeCompared == null || Decoders.decoder_dutch_postal                            != mConfigToBeCompared.Decoders.decoder_dutch_postal                      ) barcodeProps.putBoolean(   "decoder_dutch_postal"                     , Decoders.decoder_dutch_postal                     );
        if(mConfigToBeCompared == null || Decoders.decoder_ean13                                   != mConfigToBeCompared.Decoders.decoder_ean13                             ) barcodeProps.putBoolean(   "decoder_ean13"                            , Decoders.decoder_ean13                            );
        if(mConfigToBeCompared == null || Decoders.decoder_ean8                                    != mConfigToBeCompared.Decoders.decoder_ean8                              ) barcodeProps.putBoolean(   "decoder_ean8"                             , Decoders.decoder_ean8                             );
        if(mConfigToBeCompared == null || Decoders.decoder_gs1_databar                             != mConfigToBeCompared.Decoders.decoder_gs1_databar                       ) barcodeProps.putBoolean(   "decoder_gs1_databar"                      , Decoders.decoder_gs1_databar                      );
        if(mConfigToBeCompared == null || Decoders.decoder_hanxin                                  != mConfigToBeCompared.Decoders.decoder_hanxin                            ) barcodeProps.putBoolean(   "decoder_hanxin"                           , Decoders.decoder_hanxin                           );
        if(mConfigToBeCompared == null || Decoders.decoder_i2of5                                   != mConfigToBeCompared.Decoders.decoder_i2of5                             ) barcodeProps.putBoolean(   "decoder_i2of5"                            , Decoders.decoder_i2of5                            );
        if(mConfigToBeCompared == null || Decoders.decoder_japanese_postal                         != mConfigToBeCompared.Decoders.decoder_japanese_postal                   ) barcodeProps.putBoolean(   "decoder_japanese_postal"                  , Decoders.decoder_japanese_postal                  );
        if(mConfigToBeCompared == null || Decoders.decoder_korean_3of5                             != mConfigToBeCompared.Decoders.decoder_korean_3of5                       ) barcodeProps.putBoolean(   "decoder_korean_3of5"                      , Decoders.decoder_korean_3of5                      );
        if(mConfigToBeCompared == null || Decoders.decoder_mailmark                                != mConfigToBeCompared.Decoders.decoder_mailmark                          ) barcodeProps.putBoolean(   "decoder_mailmark"                         , Decoders.decoder_mailmark                         );
        if(mConfigToBeCompared == null || Decoders.decoder_matrix_2of5                             != mConfigToBeCompared.Decoders.decoder_matrix_2of5                       ) barcodeProps.putBoolean(   "decoder_matrix_2of5"                      , Decoders.decoder_matrix_2of5                      );
        if(mConfigToBeCompared == null || Decoders.decoder_maxicode                                != mConfigToBeCompared.Decoders.decoder_maxicode                          ) barcodeProps.putBoolean(   "decoder_maxicode"                         , Decoders.decoder_maxicode                         );
        if(mConfigToBeCompared == null || Decoders.decoder_micropdf                                != mConfigToBeCompared.Decoders.decoder_micropdf                          ) barcodeProps.putBoolean(   "decoder_micropdf"                         , Decoders.decoder_micropdf                         );
        if(mConfigToBeCompared == null || Decoders.decoder_microqr                                 != mConfigToBeCompared.Decoders.decoder_microqr                           ) barcodeProps.putBoolean(   "decoder_microqr"                          , Decoders.decoder_microqr                          );
        if(mConfigToBeCompared == null || Decoders.decoder_msi                                     != mConfigToBeCompared.Decoders.decoder_msi                               ) barcodeProps.putBoolean(   "decoder_msi"                              , Decoders.decoder_msi                              );
        if(mConfigToBeCompared == null || Decoders.decoder_pdf417                                  != mConfigToBeCompared.Decoders.decoder_pdf417                            ) barcodeProps.putBoolean(   "decoder_pdf417"                           , Decoders.decoder_pdf417                           );
        if(mConfigToBeCompared == null || Decoders.decoder_qrcode                                  != mConfigToBeCompared.Decoders.decoder_qrcode                            ) barcodeProps.putBoolean(   "decoder_qrcode"                           , Decoders.decoder_qrcode                           );
        if(mConfigToBeCompared == null || Decoders.decoder_signature                               != mConfigToBeCompared.Decoders.decoder_signature                         ) barcodeProps.putBoolean(   "decoder_signature"                        , Decoders.decoder_signature                        );
        if(mConfigToBeCompared == null || Decoders.decoder_tlc39                                   != mConfigToBeCompared.Decoders.decoder_tlc39                             ) barcodeProps.putBoolean(   "decoder_tlc39"                            , Decoders.decoder_tlc39                            );
        if(mConfigToBeCompared == null || Decoders.decoder_trioptic39                              != mConfigToBeCompared.Decoders.decoder_trioptic39                        ) barcodeProps.putBoolean(   "decoder_trioptic39"                       , Decoders.decoder_trioptic39                       );
        if(mConfigToBeCompared == null || Decoders.decoder_uk_postal                               != mConfigToBeCompared.Decoders.decoder_uk_postal                         ) barcodeProps.putBoolean(   "decoder_uk_postal"                        , Decoders.decoder_uk_postal                        );
        if(mConfigToBeCompared == null || Decoders.decoder_upca                                    != mConfigToBeCompared.Decoders.decoder_upca                              ) barcodeProps.putBoolean(   "decoder_upca"                             , Decoders.decoder_upca                             );
        if(mConfigToBeCompared == null || Decoders.decoder_upce0                                   != mConfigToBeCompared.Decoders.decoder_upce0                             ) barcodeProps.putBoolean(   "decoder_upce0"                            , Decoders.decoder_upce0                            );
        if(mConfigToBeCompared == null || Decoders.decoder_upce1                                   != mConfigToBeCompared.Decoders.decoder_upce1                             ) barcodeProps.putBoolean(   "decoder_upce1"                            , Decoders.decoder_upce1                            );
        if(mConfigToBeCompared == null || Decoders.decoder_us4state                                != mConfigToBeCompared.Decoders.decoder_us4state                          ) barcodeProps.putBoolean(   "decoder_us4state"                         , Decoders.decoder_us4state                         );
        if(mConfigToBeCompared == null || Decoders.decoder_usplanet                                != mConfigToBeCompared.Decoders.decoder_usplanet                          ) barcodeProps.putBoolean(   "decoder_usplanet"                         , Decoders.decoder_usplanet                         );
        if(mConfigToBeCompared == null || Decoders.decoder_uspostnet                               != mConfigToBeCompared.Decoders.decoder_uspostnet                         ) barcodeProps.putBoolean(   "decoder_uspostnet"                        , Decoders.decoder_uspostnet                        );
        if(mConfigToBeCompared == null || Decoders.decoder_webcode                                 != mConfigToBeCompared.Decoders.decoder_webcode                           ) barcodeProps.putBoolean(   "decoder_webcode"                          , Decoders.decoder_webcode                          );
    }
