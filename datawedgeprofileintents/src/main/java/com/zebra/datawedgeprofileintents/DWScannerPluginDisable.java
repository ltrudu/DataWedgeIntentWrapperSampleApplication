...
public class DWScannerPluginDisable extends DWProfileCommandBase {
    ...
    public void execute(DWProfileBaseSettings settings, onProfileCommandResult callback)
    {
        ...
        Disable plugin
         */
        sendDataWedgeIntentWithExtraRequestResult(DataWedgeConstants.DWAPI_ACTION_SCANNERINPUTPLUGIN, DataWedgeConstants.EXTRA_PARAMETER, DataWedgeConstants.DWAPI_PARAMETER_SCANNERINPUTPLUGIN_DISABLE);
     }
}
