...
public class DWDataWedgeDisable extends DWProfileCommandBase {

    public DWDataWedgeDisable(Context aContext) {
        super(aContext);
    }
    ...
    public void execute(DWProfileBaseSettings settings, onProfileCommandResult callback)
    {
        ...
        Start Scan
         */
        sendDataWedgeIntentWithExtraRequestResult(DataWedgeConstants.ACTION_DATAWEDGE_FROM_6_2, DataWedgeConstants.EXTRA_ENABLE_DATAWEDGE, false);
     }
}
