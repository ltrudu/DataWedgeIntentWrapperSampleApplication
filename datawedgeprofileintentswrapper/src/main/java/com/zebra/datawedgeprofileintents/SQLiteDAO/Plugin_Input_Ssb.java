...
public class Plugin_Input_Ssb {
    ...
    public Plugin_Input_Ssb() {
    }

    public Plugin_Input_Ssb(Integer _id, Integer profile_id, String plugin_id, String device_id, String param_id, String param_value) {
        this.m_id = _id;
    ...
    public Plugin_Input_Ssb(Bundle b) {
        if (b != null) {
