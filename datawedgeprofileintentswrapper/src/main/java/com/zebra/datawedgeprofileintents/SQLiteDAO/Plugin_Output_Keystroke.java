...
public class Plugin_Output_Keystroke {
    ...
    public Plugin_Output_Keystroke() {
    }

    public Plugin_Output_Keystroke(Integer _id, Integer profile_id, String plugin_id, String param_id, String param_value) {
        this.m_id = _id;
    ...
    public Plugin_Output_Keystroke(Bundle b) {
        if (b != null) {
