...
public class Plugin_Output_Ip {
    ...
    public Plugin_Output_Ip() {
    }

    public Plugin_Output_Ip(Integer _id, Integer profile_id, String plugin_id, String device_id, String param_id, String param_value) {
        this.m_id = _id;
    ...
    public Plugin_Output_Ip(Bundle b) {
        if (b != null) {
