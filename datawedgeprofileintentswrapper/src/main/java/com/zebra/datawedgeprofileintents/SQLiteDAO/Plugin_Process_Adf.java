...
public class Plugin_Process_Adf {
    ...
    public Plugin_Process_Adf() {
    }

    public Plugin_Process_Adf(Integer _id, Integer profile_id, String plugin_id, String device_id, String param_id, String param_value) {
        this.m_id = _id;
    ...
    public Plugin_Process_Adf(Bundle b) {
        if (b != null) {
