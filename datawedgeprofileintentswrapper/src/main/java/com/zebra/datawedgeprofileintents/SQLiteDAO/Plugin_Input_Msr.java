...
public class Plugin_Input_Msr {
    ...
    public Plugin_Input_Msr() {
    }

    public Plugin_Input_Msr(Integer _id, Integer profile_id, String plugin_id, String device_id, String param_id, String param_value) {
        this.m_id = _id;
    ...
    public Plugin_Input_Msr(Bundle b) {
        if (b != null) {
